...
your roster.py program. (I already put it in the same folder as this file)
...
for entry in json_data:
    ...
    c.execute('''INSERT OR IGNORE INTO User (name)
        VALUES ( ? )''', ( name, ))
    ...
    c.execute('''INSERT OR REPLACE INTO Member
